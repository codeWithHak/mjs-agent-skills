#!/usr/bin/env python3
"""Verify orchestrating-subagents skill structure."""
import os
import sys
...
def main():
    ...
    required_sections = ["Parallelize", "Prompt Structure", "Dispatch Patterns", "Common Mistakes"]
    ...
    print("OK orchestrating-subagents skill ready")
    sys.exit(0)
